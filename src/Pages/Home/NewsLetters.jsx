...
const NewsLetters = () => {
  return (
    <div className='bg-[#1E2832] bg-opacity-5 xl:px-10 px-4 py-12'>
         <h2 className="text-3xl font-semibold text-center capitalize mb-8">
            Follow products and discounts on Instagram
         </h2>

        {/* insta grid */}
        <div className='flex flex-wrap gap-3 items-center justify-center mb-14'>
        ...
        <form className='md:w-1/2 mx-auto text-center'>
            <input type="email" name='email' id='email' placeholder='Email Address' className='h-5
